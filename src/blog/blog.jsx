    ...
    return (
        ...
        <Navbar/>
            <div className='blogcontainer'>
                ...
                <h2 >Warning: Although these thoughts reveal more clearly how I navigate through life, reading it may not be for everyone.   </h2>
                </div>
                <div className='blog'>
                    <h2>Entry 1</h2>
                    <h3>2:02 AM - May 5th, 2025</h3>
                    <h4>My Night-time Thoughts on Highschool</h4>
                    <p>
